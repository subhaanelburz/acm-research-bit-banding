...
int main(void)
{
    ...
    volatile uint32_t ticks_set_clear = 0;
    volatile uint32_t ticks_set_only = 0;
    volatile uint32_t ticks_clear_only = 0;
    ...
    ticks_set_clear = (start_ticks - end_ticks) & 0x00FFFFFF; // will be the raw number of clock cycles / ticks
    ...
    ticks_set_only = (start_ticks - end_ticks) & 0x00FFFFFF; // will be the raw number of clock cycles / ticks
    ...
    ticks_clear_only = (start_ticks - end_ticks) & 0x00FFFFFF; // will be the raw number of clock cycles / ticks
